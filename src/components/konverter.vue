    ...
    <v-row class="justify-center">
      <v-col cols="12">
        <h4 class="text-center">
          Unesi link youtube videa koji želiš pretvoriti u mp3
        </h4>
      </v-col>
      <v-col cols="6" md="4">
        <h2>Unesi Youtube link:</h2>
        <v-text-field v-model="url" outlined dense label="Pretraga..."></v-text-field>
        <v-btn @click="search">Konvertuj</v-btn>
        ...
        <v-card v-show="card" elevation="0">
          <v-row>
            ...
            <v-spacer></v-spacer>
            <v-col cols="12" sm="6">
              <v-btn :href="data.link" color="green" style="color: white" rounded>Preuzmi</v-btn>
            </v-col>
            <v-spacer></v-spacer>
          </v-row>
